...
#endif
#ifdef USE_EIGEN_BACKEND
  cout << "You are currently using the eigen1.Eigen (CPU) version of KataGo. Due to having no GPU, it may be slow." << endl;
#endif
  cout << endl;
...
#ifdef USE_EIGEN_BACKEND
  //eigen1.Eigen is a little interesting in that by default, it sets numNNServerThreadsPerModel based on numSearchThreads
